...
public class FloorplanData {
    ...
    public ArrayList<Floorplan> GetAllFloorplans() {
        ...
        try {
            ...
            ResultSet rs = stmt.executeQuery("SELECT * FROM floorplans");
            ...
            System.out.println("Floorplans: " + e);
        }
    ...
    public void CreateFloorplan(Floorplan floorplan) {
        try {
            ...
            int status = stmt.executeUpdate("INSERT INTO `floorplans` (`image`,`ssid`,`name`, `width`, `scale`) VALUES ('"+ floorplan.getImage()  +"', '"+ floorplan.getSSID() +"', '"+ floorplan.getName() + "', '"+ floorplan.getWidth() + "', '"+ floorplan.getScale() + "');");
    ...
    public void DeleteFloorplan(String name) {
        try {
            ...
            status += String.valueOf(stmt.executeUpdate("DELETE FROM `floorplans` WHERE name='"+ name +"';"));

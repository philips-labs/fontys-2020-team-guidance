...
public class UserDataCollection {
    ...
    public void UpdateNodeCount(int nodeId, String email, String floorplanId, String ssid) {
        userDataData.UpdateNodeConnection(nodeId, email, floorplanId, ssid);
    }

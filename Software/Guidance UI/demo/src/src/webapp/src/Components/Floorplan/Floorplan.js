    ...
    render() {
        return (
            <div id={"floorplan-container"}>
                <div id={"user"} className={"floorplanNode"} style={{position: "absolute", left: "0px", top: "0px", backgroundColor: "green", padding: "8px", borderRadius: "45px", border: "3px solid white", zIndex: 100}}/>
                <img alt=""
                     className="img"
